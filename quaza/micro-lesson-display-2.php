...
<div class="quiz-list-7"></div>
 ...
 <div class="mp4">
   <div class="bar-1"></div>
    <a href="#" style="color: #000;float:right; margin: 20px 40px 20px 0;" onClick="stopVideo();">Close</a>
   <div class="modalBody">
...
<div id="popup3" class="q-modalBox" href="http://localhost:8080/recordData?questionBankID=1">
 ...
 <div class="qBank">
   <div class="question-bank-top-bar"><div class="question-bank-top-text">Question Bank Question 1</div><a href="#" style="color: #000; float:right; margin: -30px 40px 20px 0;" onClick="apiCall();">Close</a></div>
